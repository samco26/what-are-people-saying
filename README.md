...
## Current checkpoint: BETA 0.13.0 — merged checkpoint
...
The tests, TypeScript, production build and simulated desktop/mobile checks pass. This checkpoint merges GitHub changes through BETA 0.12.8, including the advisory lookup, narrower review categories, compact meter, phone spacing and removal of About this answer. It is awaiting push/deployment verification and has not been tested with paid live searches; no speedup, billed saving or live quality improvement is claimed. The last verified deployment is BETA 0.12.2, commit `3870bd8`.
