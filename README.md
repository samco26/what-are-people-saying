...
## Current checkpoint: BETA 0.12.4
...
- Current checkpoint (0.12.4): the plan-instruction test asserts the listing rule and its exclusions, and the harness parsed 37 files, mounted the app and drew the new Harbour Lane Burgers place card and the relabelled Melbourne answer; nothing ran under Node.js here. Whether the model applies the rule to real names (smartphones, Rome, Apple, McDonald's) is the live check to make.
