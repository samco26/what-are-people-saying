...
A user enters the name of a subject. The application retrieves a controlled sample from YouTube, X and Reddit, analyses relevant discussion, and returns one simple consensus statement with supporting themes and source counts.

This is a simple consumer-facing, personal, non-commercial project. Visitors encounter the search function immediately.

## Required result

- One-sentence consensus about the sampled discussion.
...
- Complicated date or source controls.
...
- Final name and visual personality.
- Colour palette and light/dark preference.
- Search-and-result interaction versus follow-up chat.
- How much result detail is immediately visible.
- Desktop/mobile priority and visual references.

Advanced filters, demographic controls, accounts and payments are excluded regardless of earlier brainstorming.
