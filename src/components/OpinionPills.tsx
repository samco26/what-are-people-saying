...
/* Every recurring opinion is rendered. Desktop positions the first six
   around the answer and hides the rest, which Show more opinions (under the
   card, in SearchCard) lists in full; phones list them all under the answer
   in a box that scrolls on its own. The frame only exists on phones, where
   it carries the fade at the bottom of the scrolling list; on desktop it is
   display:contents. */
